...
* Demand Process: ![formula](https://render.githubusercontent.com/render/math?math=p%20p%20\to%20t%20\bar{t}%20\to%20W^{+}b%20W^{-}\bar{b}%20\to%20q\bar{q}bq\bar{q}\bar{b}) (full hadronic channel, 6 jets)
