...
/bin/cp -f /workplace/HEP-jet-assignment/madgraph/delphes_card_ATLAS.tcl /MG5_aMC_v2_7_3/Delphes/cards/;
/bin/cp -avr /workplace/HEP-jet-assignment/madgraph/pptt_preparation/default/* ./;

# Set Seed
export SEED=$(cat /home/david/seed.txt)
