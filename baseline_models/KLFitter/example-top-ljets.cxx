...
int main(int argc, char *argv[]) {
  ...
  auto f_input = TFile::Open((base_dir + "/data/examples/ttHttbbsepe.root").c_str(), "READ");
  if (f_input == nullptr) {
  ...
  likelihood.PhysicsConstants()->SetMassTop(173); 
  ...
  //Do debug : change "nEntries" to 1000000
